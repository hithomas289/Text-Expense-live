...
const data = {
  ...
  MAIN_CONTENT: `
    <section style="padding: 60px 20px; max-width: 800px; margin: 0 auto;">
      <h2 style="font-size: 2em; margin-bottom: 20px; color: #1a1a1a;">The Field Worker Reality</h2>
    ...
    <section style="padding: 60px 20px; background: #f8f9fa;">
      <div style="max-width: 800px; margin: 0 auto;">
        <h2 style="font-size: 2em; margin-bottom: 40px; color: #1a1a1a; text-align: center;">How Field Tracking Works</h2>

        <div style="margin-bottom: 40px;">
          <h3 style="font-size: 1.5em; color: #2c3e50; margin-bottom: 15px;">Text From Anywhere</h3>
          <p style="font-size: 1.1em; line-height: 1.8; color: #333;">
        ...
        <div style="margin-bottom: 40px;">
          <h3 style="font-size: 1.5em; color: #2c3e50; margin-bottom: 15px;">Instant Processing</h3>
          <p style="font-size: 1.1em; line-height: 1.8; color: #333;">
        ...
        <div style="margin-bottom: 40px;">
          <h3 style="font-size: 1.5em; color: #2c3e50; margin-bottom: 15px;">No Office Needed</h3>
          <p style="font-size: 1.1em; line-height: 1.8; color: #333;">
        ...
        <div>
          <h3 style="font-size: 1.5em; color: #2c3e50; margin-bottom: 15px;">Organized Automatically</h3>
          <p style="font-size: 1.1em; line-height: 1.8; color: #333;">
    ...
    <section style="padding: 60px 20px; max-width: 800px; margin: 0 auto;">
      <h2 style="font-size: 2em; margin-bottom: 30px; color: #1a1a1a; text-align: center;">Field Work Expenses Tracked</h2>
    ...
    <section style="padding: 60px 20px; background: #f8f9fa;">
      <div style="max-width: 800px; margin: 0 auto;">
        <h2 style="font-size: 2em; margin-bottom: 30px; color: #1a1a1a;">Why Field Workers Don't Track</h2>

        <div style="margin-bottom: 30px;">
          <h3 style="font-size: 1.3em; color: #2c3e50; margin-bottom: 10px;">Always moving</h3>
          <p style="font-size: 1.1em; line-height: 1.8; color: #333;">
        ...
        <div style="margin-bottom: 30px;">
          <h3 style="font-size: 1.3em; color: #2c3e50; margin-bottom: 10px;">No office access</h3>
          <p style="font-size: 1.1em; line-height: 1.8; color: #333;">
        ...
        <div style="margin-bottom: 30px;">
          <h3 style="font-size: 1.3em; color: #2c3e50; margin-bottom: 10px;">Tools aren't field-friendly</h3>
          <p style="font-size: 1.1em; line-height: 1.8; color: #333;">
        ...
        <div style="margin-bottom: 30px;">
          <h3 style="font-size: 1.3em; color: #2c3e50; margin-bottom: 10px;">Time pressure</h3>
          <p style="font-size: 1.1em; line-height: 1.8; color: #333;">
        ...
        <div style="margin-bottom: 30px;">
          <h3 style="font-size: 1.3em; color: #2c3e50; margin-bottom: 10px;">Dirty hands</h3>
          <p style="font-size: 1.1em; line-height: 1.8; color: #333;">
    ...
    <section style="padding: 60px 20px; max-width: 800px; margin: 0 auto;">
      <h2 style="font-size: 2em; margin-bottom: 30px; color: #1a1a1a; text-align: center;">What Makes This Work For Field Workers</h2>

      <div style="margin-bottom: 30px;">
        <h3 style="font-size: 1.3em; color: #2c3e50; margin-bottom: 10px;">Mobile-native</h3>
        <p style="font-size: 1.1em; line-height: 1.8; color: #333;">
      ...
      <div style="margin-bottom: 30px;">
        <h3 style="font-size: 1.3em; color: #2c3e50; margin-bottom: 10px;">WhatsApp-based</h3>
        <p style="font-size: 1.1em; line-height: 1.8; color: #333;">
      ...
      <div style="margin-bottom: 30px;">
        <h3 style="font-size: 1.3em; color: #2c3e50; margin-bottom: 10px;">Works offline temporarily</h3>
        <p style="font-size: 1.1em; line-height: 1.8; color: #333;">
      ...
      <div style="margin-bottom: 30px;">
        <h3 style="font-size: 1.3em; color: #2c3e50; margin-bottom: 10px;">Fast processing</h3>
        <p style="font-size: 1.1em; line-height: 1.8; color: #333;">
      ...
      <div>
        <h3 style="font-size: 1.3em; color: #2c3e50; margin-bottom: 10px;">Personal and business</h3>
        <p style="font-size: 1.1em; line-height: 1.8; color: #333;">
    ...
    <section style="padding: 60px 20px; background: #f8f9fa;">
      <div style="max-width: 800px; margin: 0 auto;">
        ...
        <div style="margin-bottom: 30px;">
          <h3 style="font-size: 1.3em; color: #2c3e50; margin-bottom: 10px;">Can I track expenses without internet access?</h3>
          <p style="font-size: 1.1em; line-height: 1.8; color: #333;">
        ...
        <div style="margin-bottom: 30px;">
          <h3 style="font-size: 1.3em; color: #2c3e50; margin-bottom: 10px;">What if my hands are dirty from work?</h3>
          <p style="font-size: 1.1em; line-height: 1.8; color: #333;">
        ...
        <div style="margin-bottom: 30px;">
          <h3 style="font-size: 1.3em; color: #2c3e50; margin-bottom: 10px;">Can I track both work and personal receipts?</h3>
          <p style="font-size: 1.1em; line-height: 1.8; color: #333;">
        ...
        <div style="margin-bottom: 30px;">
          <h3 style="font-size: 1.3em; color: #2c3e50; margin-bottom: 10px;">What about mileage between job sites?</h3>
          <p style="font-size: 1.1em; line-height: 1.8; color: #333;">
        ...
        <div style="margin-bottom: 30px;">
          <h3 style="font-size: 1.3em; color: #2c3e50; margin-bottom: 10px;">How do I access reports from the field?</h3>
          <p style="font-size: 1.1em; line-height: 1.8; color: #333;">
        ...
        <div>
          <h3 style="font-size: 1.3em; color: #2c3e50; margin-bottom: 10px;">What if I lose receipts before photographing them?</h3>
          <p style="font-size: 1.1em; line-height: 1.8; color: #333;">
    ...
    <section style="padding: 80px 20px; text-align: center; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white;">
      <div style="max-width: 600px; margin: 0 auto;">
        ...
        <p style="font-size: 1.2em; line-height: 1.8; margin-bottom: 30px; color: white;">
          Try it with one field expense. Text a receipt photo from your truck, job site, or wherever you are. Free, no credit card.
        </p>
        ...
        <p style="font-size: 1em; margin-top: 30px; color: rgba(255,255,255,0.9);">
          Field-friendly tracking that works where you actually work.
        </p>
      </div>
    </section>
  `
