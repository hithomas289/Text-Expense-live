...
const data = {
  ...
  MAIN_CONTENT: `
    <section style="padding: 60px 20px; max-width: 800px; margin: 0 auto;">
      <h2 style="font-size: 2em; margin-bottom: 20px; color: #1a1a1a;">The Solopreneur Reality</h2>
    ...
    <section style="padding: 60px 20px; background: #f8f9fa;">
      <div style="max-width: 800px; margin: 0 auto;">
        <h2 style="font-size: 2em; margin-bottom: 40px; color: #1a1a1a; text-align: center;">How Solo Tracking Works</h2>

        <div style="margin-bottom: 40px;">
          <h3 style="font-size: 1.5em; color: #2c3e50; margin-bottom: 15px;">No Extra Systems</h3>
          <p style="font-size: 1.1em; line-height: 1.8; color: #333;">
        ...
        <div>
          <h3 style="font-size: 1.5em; color: #2c3e50; margin-bottom: 15px;">Zero Maintenance</h3>
          <p style="font-size: 1.1em; line-height: 1.8; color: #333;">
    ...
    <section style="padding: 60px 20px; max-width: 800px; margin: 0 auto;">
      <h2 style="font-size: 2em; margin-bottom: 30px; color: #1a1a1a; text-align: center;">Solo Business Expenses</h2>
    ...
    <section style="padding: 60px 20px; background: #f8f9fa;">
      <div style="max-width: 800px; margin: 0 auto;">
        <h2 style="font-size: 2em; margin-bottom: 30px; color: #1a1a1a;">Why Solopreneurs Don't Track</h2>

        <div style="margin-bottom: 30px;">
          <h3 style="font-size: 1.3em; color: #2c3e50; margin-bottom: 10px;">Too many hats</h3>
          <p style="font-size: 1.1em; line-height: 1.8; color: #333;">
        ...
        <div style="margin-bottom: 30px;">
          <h3 style="font-size: 1.3em; color: #2c3e50; margin-bottom: 10px;">No dedicated time</h3>
          <p style="font-size: 1.1em; line-height: 1.8; color: #333;">
        ...
        <div style="margin-bottom: 30px;">
          <h3 style="font-size: 1.3em; color: #2c3e50; margin-bottom: 10px;">System overwhelm</h3>
          <p style="font-size: 1.1em; line-height: 1.8; color: #333;">
        ...
        <div style="margin-bottom: 30px;">
          <h3 style="font-size: 1.3em; color: #2c3e50; margin-bottom: 10px;">Unclear ROI</h3>
          <p style="font-size: 1.1em; line-height: 1.8; color: #333;">
        ...
        <div style="margin-bottom: 30px;">
          <h3 style="font-size: 1.3em; color: #2c3e50; margin-bottom: 10px;">Energy depletion</h3>
          <p style="font-size: 1.1em; line-height: 1.8; color: #333;">
    ...
    <section style="padding: 60px 20px; max-width: 800px; margin: 0 auto;">
      ...
      <div style="margin-bottom: 30px;">
        <h3 style="font-size: 1.3em; color: #2c3e50; margin-bottom: 10px;">Fits existing workflow</h3>
        <p style="font-size: 1.1em; line-height: 1.8; color: #333;">
      ...
      <div style="margin-bottom: 30px;">
        <h3 style="font-size: 1.3em; color: #2c3e50; margin-bottom: 10px;">Minimal time investment</h3>
        <p style="font-size: 1.1em; line-height: 1.8; color: #333;">
      ...
      <div style="margin-bottom: 30px;">
        <h3 style="font-size: 1.3em; color: #2c3e50; margin-bottom: 10px;">No system maintenance</h3>
        <p style="font-size: 1.1em; line-height: 1.8; color: #333;">
      ...
      <div>
        <h3 style="font-size: 1.3em; color: #2c3e50; margin-bottom: 10px;">Accountant-ready output</h3>
        <p style="font-size: 1.1em; line-height: 1.8; color: #333;">
    ...
    <section style="padding: 60px 20px; background: #f8f9fa;">
      <div style="max-width: 800px; margin: 0 auto;">
        ...
        <div style="margin-bottom: 30px;">
          <h3 style="font-size: 1.3em; color: #2c3e50; margin-bottom: 10px;">Is this enough for my business?</h3>
          <p style="font-size: 1.1em; line-height: 1.8; color: #333;">
        ...
        <div style="margin-bottom: 30px;">
          <h3 style="font-size: 1.3em; color: #2c3e50; margin-bottom: 10px;">What about expenses I already paid?</h3>
          <p style="font-size: 1.1em; line-height: 1.8; color: #333;">
        ...
        <div style="margin-bottom: 30px;">
          <h3 style="font-size: 1.3em; color: #2c3e50; margin-bottom: 10px;">Can I track both business and personal?</h3>
          <p style="font-size: 1.1em; line-height: 1.8; color: #333;">
        ...
        <div style="margin-bottom: 30px;">
          <h3 style="font-size: 1.3em; color: #2c3e50; margin-bottom: 10px;">How does categorization work?</h3>
          <p style="font-size: 1.1em; line-height: 1.8; color: #333;">
        ...
        <div style="margin-bottom: 30px;">
          <h3 style="font-size: 1.3em; color: #2c3e50; margin-bottom: 10px;">What if I forget to track something?</h3>
          <p style="font-size: 1.1em; line-height: 1.8; color: #333;">
        ...
        <div>
          <h3 style="font-size: 1.3em; color: #2c3e50; margin-bottom: 10px;">Will my accountant understand the reports?</h3>
          <p style="font-size: 1.1em; line-height: 1.8; color: #333;">
    ...
    <section style="padding: 80px 20px; text-align: center; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white;">
      <div style="max-width: 600px; margin: 0 auto;">
        ...
        <p style="font-size: 1.2em; line-height: 1.8; margin-bottom: 30px; color: white;">
          Try it with one expense. Text a receipt photo via WhatsApp, see how automatic processing works. Free, no credit card needed.
        </p>
        ...
        <p style="font-size: 1em; margin-top: 30px; color: rgba(255,255,255,0.9);">
          Solopreneur-friendly tracking that doesn't add to your workload.
        </p>
      </div>
    </section>
  `
